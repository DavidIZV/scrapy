...
HEADER = Header(
    column_names=[
        'price', 'km', 'make', 'transmissionType', 'year', 'seller_type',
...
def build_feature_transform():
    ...
    numeric = HEADER.as_feature_indices(
        [
            'km', 'make', 'transmissionType', 'year', 'bodyType',
    ...
    categorical = HEADER.as_feature_indices(
        [
            'make', 'transmissionType', 'year', 'bodyType', 'cubicCapacity',
            'hp', 'acceleration', 'length', 'width'
        ]
    )
